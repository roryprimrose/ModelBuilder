namespace ModelBuilder.UnitTests
{
    ...
    public class EnumerableTypeCreatorTests
    {
        ...
        [InlineData(typeof(Dictionary<A, A>.KeyCollection), false)]
        [InlineData(typeof(Dictionary<A, A>.ValueCollection), false)]
        [InlineData(typeof(Dictionary<string, int>), true)]
        [InlineData(typeof(SortedDictionary<A, A>.KeyCollection), false)]
        [InlineData(typeof(SortedDictionary<A, A>.ValueCollection), false)]
