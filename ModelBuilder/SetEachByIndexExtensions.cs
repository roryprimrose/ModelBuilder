namespace ModelBuilder
{
    ...
    /// <summary>
    ///     The <see cref="SetEachByIndexExtensions" />
    ///     class provides SetEach extension methods that provide an index for each item being modified.
    /// </summary>
    public static class SetEachByIndexExtensions
    {
        /// <summary>
        ...
        public static List<T> SetEach<T>(this IEnumerable<T> instances, Action<int, T> action) where T : class
        {
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static IList<T> SetEach<T>(this IList<T> instances, Action<int, T> action) where T : class
        {
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static IReadOnlyList<T> SetEach<T>(this IReadOnlyList<T> instances, Action<int, T> action)
            where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static List<T> SetEach<T>(this List<T> instances, Action<int, T> action) where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static Collection<T> SetEach<T>(this Collection<T> instances, Action<int, T> action) where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static ICollection<T> SetEach<T>(this ICollection<T> instances, Action<int, T> action) where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static IReadOnlyCollection<T> SetEach<T>(this IReadOnlyCollection<T> instances, Action<int, T> action)
            where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static ReadOnlyCollection<T> SetEach<T>(this ReadOnlyCollection<T> instances, Action<int, T> action)
            where T : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        public static IDictionary<TKey, TValue> SetEach<TKey, TValue>(this IDictionary<TKey, TValue> instances,
            Action<int, KeyValuePair<TKey, TValue>> action) where TValue : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        public static Dictionary<TKey, TValue> SetEach<TKey, TValue>(this Dictionary<TKey, TValue> instances,
            Action<int, KeyValuePair<TKey, TValue>> action) where TKey : notnull where TValue : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        public static IReadOnlyDictionary<TKey, TValue> SetEach<TKey, TValue>(
            this IReadOnlyDictionary<TKey, TValue> instances, Action<int, KeyValuePair<TKey, TValue>> action)
            where TValue : class
        {
            return SetEachExplicit(instances, action);
        }
        ...
        public static ReadOnlyDictionary<TKey, TValue> SetEach<TKey, TValue>(
            this ReadOnlyDictionary<TKey, TValue> instances, Action<int, KeyValuePair<TKey, TValue>> action)
            where TKey : notnull
            where TValue : class
        {
            return SetEachExplicit(instances, action);
        ...
        [SuppressMessage(
            ...
            Justification =
                "For usability in the calling code, the return type reflects the actual type to avoid unnecessary conversion or casting.")]
        public static TList SetEachExplicit<TList, TEntry>(this TList instances, Action<int, TEntry> action)
        ...
        public static TDictionary SetEachExplicit<TDictionary, TKey, TValue>(this TDictionary instances,
            Action<int, KeyValuePair<TKey, TValue>> action) where TDictionary : IEnumerable<KeyValuePair<TKey, TValue>>
            where TValue : class
        {
            instances = instances ?? throw new ArgumentNullException(nameof(instances));
            action = action ?? throw new ArgumentNullException(nameof(action));
